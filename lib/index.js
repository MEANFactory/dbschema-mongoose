...
function writeIndexFiles(worker){
    ...
    dbs.forEach(function(db){
        ...
        eol = (lastDb === db) ? '' : ',';
        rootLines.push('    ' + toPropertyName(db.name) + ': require(\'./' + toPropertyName(db.name) + '\')' + eol);
        ...
        schemas.forEach(function(schema){
            ...
            dbLines.push('    ' + toPropertyName(schema.name) + ': require(\'./' + toPropertyName(schema.name) + '\')' + eol);
            ...
            items.forEach(function(item){
                eol = (lastItem === item) ? '' : ',';
                schemaLines.push('    ' + toModelName(item.name) + ': require(\'./' + toPropertyName(item.name) + '\')' + eol);
            });
